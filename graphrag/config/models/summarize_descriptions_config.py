...
class SummarizeDescriptionsConfig(LLMConfig):
    ...
    prompt: str | None = Field(description="The description summarization prompt to use.", default=None)
    ...
    def resolved_strategy(self, root_dir: str) -> dict:
        ...
        return self.strategy or {
            ...
            **self.parallelization.model_dump(),
            "summarize_prompt": (Path(root_dir) / self.prompt).read_bytes().decode(encoding="utf-8")
            if self.prompt
            else None,
